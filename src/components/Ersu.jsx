      ...
      <div className="ersu-wrapper">
        ...
        <div className="ersu-card">
          ...
          <p className="p1">
            ...
            old. At Nordic Air Group, Ersu has been fueled by a lifelong passion
            for aircraft and aviation. His journey also includes triumph in a
            pitching competition, where he acquired invaluable skills. These
            skills and experiences are now an asset to his role at NAG, where he
            is determined to make a significant impact.
          </p>
          <p className="p2">
            Contact:
            <br />
