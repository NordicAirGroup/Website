          ...
          <div className="ourstory-card-container">
            <div className="ourstory-card">
              ...
              <p>
                ...
                which Ersu shared his deep passion for aviation and his
                aspirations to become a pilot or aviation broker. Joar, recently
                landing a role in appointment setting, saw an opportunity. He
                suggested Ersu could gain valuable experience and connections
                through similar work. Initially neutral, Ersu warmed up to the
                idea as they explored it further, realizing they could add
                genuine value to the field. Thus, a dream took flight: entering
                ...
                parties. Aiming to give substantially more value, than they
                take.
                <br />
                <br />
                ...
                apart. While many in our generation might hesitate to go the
                extra mile, we are committed to conquer the challenges that lie
                ahead – and, on a lighter note, we're also looking to fund our
                pilot licenses!
              </p>
            </div>
          </div>
